 ...
 * @author Cliente
 */
public class JFrameRelatorioCliente extends javax.swing.JDialog{

    /**
     * Creates new form JFrameRelatorioCliente
     */
    public JFrameRelatorioCliente() {
        setModal(true);
        //super("Relatorio de Cliente - ConstruMaX");
        setIcon();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Clientes - Constru MaX");
        setResizable(false);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"123123", "Carla Sousa Dias", "890976543", "97258989", "Ico"},
                {"745674", "lucas de Lima lopes", "937573930", "99876666", "Ico"},
                {"11771019", "Cacio Bezerra ", "92750596", "92324466", "Ico"},
                {"3141453", "Amaral Araujo Duarte", "829404739", "98654321", "Ico"},
                {"123421", "Samara Pereira Nunes", "143658493", "96556633", "Ico"},
                {"12341234", "Antonio Juiz alves", "294657026", "97889900", "Ico"},
                {"134635635", "Leonardo de martins", "374950285", "88467733", "Ico"},
                {"12343", "Rafael de Lima Campos", "955748220", "92324411", "Ico"},
                {"12341234", "Dalila do Carmo", "152384675", "99876503", "Ico"},
                {"123565467", "Antonio Vandeilton Souza", "859473859", "92324567", "Ico"}
            },
            new String [] {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameRelatorioCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
